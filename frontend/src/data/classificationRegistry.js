...
export const CLASSIFICATION_TAGS = {
    ...
    te_same: {
        dim: "entry_model",
        label: "TE C0 (Same Candle)",
        tone: "info",
        description: "Triggered-edge limit armed and filled on the same candle as trigger (delay 0).",
    },
    te_next: {
        dim: "entry_model",
        label: "TE C1 (Next Candle)",
        tone: "info",
    ...
    te_d2: {
        ...
        label: "TE C2 (+2 Delay)",
        tone: "info",
        description: "Triggered-edge limit armed after a 2-candle delay window (delay 2).",
    },
    te_d3: {
        dim: "entry_model",
        label: "TE C3 (+3 Delay)",
        tone: "info",
        description: "Triggered-edge limit armed after a 3-candle delay window (delay 3).",
    },
    ep_25: {
        dim: "entry_model",
        label: "EP 25%",
