...
export default function DeepDive({ session, activeTab, setActiveTab, overviewData, directionData, structureData, timeAnalysisData, entryModelData, orderBlockData, failureData }) {
  return (
