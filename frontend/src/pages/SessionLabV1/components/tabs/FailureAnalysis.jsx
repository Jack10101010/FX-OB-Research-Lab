        ...
        <div className="rounded border border-[#EF4444]/30 bg-gradient-to-b from-[#1A0F14] to-[#0D1520] p-4">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-3 mb-3">
            <div>
              ...
              <div className="font-num tabular text-2xl font-bold text-[#EF4444]">{WORST_CLUSTER.losses}</div>
            </div>
            <div>
              <div className="label-eyebrow">Net R Impact</div>
              <div className="font-num tabular text-2xl font-bold text-[#EF4444]">{fmtR(WORST_CLUSTER.netR, 2)}</div>
            </div>
            <div>
              <div className="label-eyebrow">Time Window</div>
              <div className="font-num text-sm text-[hsl(var(--text))]">{WORST_CLUSTER.window}</div>
            </div>
            <div>
              <div className="label-eyebrow">Trades</div>
              <div className="font-num text-sm text-[hsl(var(--text))]">{WORST_CLUSTER.trades}</div>
            </div>
          </div>
          <div className="rounded-md bg-[hsl(var(--panel-2))] border border-[hsl(var(--border-soft))] p-3 mb-3">
            ...
            <div className="font-num text-[11px] text-[hsl(var(--warning))]">{WORST_CLUSTER.cause}</div>
          </div>
