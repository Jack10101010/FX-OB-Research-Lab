...
export default function SessionLabPage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1600px] px-6 md:px-8 lg:px-10 py-6 md:py-8 space-y-6 md:space-y-8">
        <Header
          direction={direction}
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_280px_360px] gap-6">
          <DeepDive
            session={selected}
            activeTab={activeTab}
