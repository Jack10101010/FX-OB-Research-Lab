// ── filterSimulator.js ───────────────────────────────────────────────────────
// Failures Lab V5 Phase 1 — the filter-discovery / cohort-removal simulator.
//
...
//
// Relationship to the other engines (audited 2026-06-10):
//   • aggregateFailures      — share/lift attribution ("who carries the damage?").
//                              Stays as the DIAGNOSTIC layer; this is the DECISION layer.
//   • computePreventionRules — same both-sides idea over a HARDCODED rule list.
//                              This module generalizes it across the dimension
//                              registry + curated pairs; Prevention keeps its
//                              severity weighting / hypothesis bridge.
//
...
import {
    FAILURE_DIMENSIONS, DIMENSION_BY_KEY, resolveDimension, dimensionAvailable,
} from "./failuresDimensions";
