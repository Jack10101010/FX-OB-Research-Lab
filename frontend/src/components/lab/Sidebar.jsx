...
import {
    ...
    BookOpen, ChevronLeft, Microscope, Lightbulb, Clock, Gauge, Telescope,
} from "lucide-react";
...
const NAV_GROUPS = [
    {
        ...
        items: [
            ...
            // CLUSTER-1: guided multi-dimensional discovery engine.
            { to: "/cluster-explorer", label: "Cluster Explorer", icon: Telescope },
